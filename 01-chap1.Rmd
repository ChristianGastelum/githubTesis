...
Así mismo, mantener un centro de datos no solo requiere constante monitoreo del equipo de cómputo, sino además, es necesario monitorizar todos los componentes del centro de datos, tales como:
