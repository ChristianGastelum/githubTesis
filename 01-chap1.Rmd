...
Un centro de datos es un edificio que alberga el equipo de procesamiento de datos y telecomunicaciones de una o varias compañías u organizaciones. Adicionalmente, este debe constar de al menos un cuarto separado con suministro de energía independiente y control de clima @Cap1_4_PdP. Alguno de los componentes que se pueden llegar a encontrar en este tipo de cuartos son: 
