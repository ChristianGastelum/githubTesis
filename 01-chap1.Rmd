...
<!-- donde alojaban desde un par de servidores a cientos de estos.--> 
...
<!--u organizaciones; este, debe  -->

Adicionalmente, un centro de datos debe constar de al menos un cuarto separado, donde se: encuentre suministro de energía independiente y control de clima @Cap1_4_PdP.
